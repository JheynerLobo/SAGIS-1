                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                               ...
                                               <td> 
                                                ...
                                                <div class="icons-acciones">
                                                    ...
                                                    <div class="mr-3">
                                                        ...
                                                        href="{{ route('admin.posts.edit_image', [$item->id, $image->id ] ) }}">
                                                    ...
                                                    <div class="mr-3">
                                                        ...
                                                        <form action="{{ route('admin.posts.destroy_image', [$item->id, $image->id ]) }}"
                                ...
                                <div class="mt-2">
                                    <a href="{{ route('admin.posts.create_image', $item->id) }}" class="btn btn-sm btn-danger">
