...
@section('title', 'Imágenes del reconocimiento')
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header  border-info">
                            <h3 class="card-title"><strong>Imágenes del reconocimiento:</strong> </h3>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                               ...
                                               <td> 
                                                ...
                                                <div class="icons-acciones">
                                                    ...
                                                    <div class="mr-3">
                                                        ...
                                                        href="{{ route('admin.graduateQuality.edit_image', [$item->id, $image->id ] ) }}">
                                                    ...
                                                    <div class="mr-3">
                                                        ...
                                                        <form action="{{ route('admin.graduateQuality.destroy_image', [$item->id, $image->id ]) }}"
                                ...
                                <div class="mt-2">
                                    <a href="{{ route('admin.graduateQuality.create_image', $item->id) }}" class="btn btn-sm btn-danger">
                                        Añadir nueva imagen</a>
                                </div>
                            </div>
