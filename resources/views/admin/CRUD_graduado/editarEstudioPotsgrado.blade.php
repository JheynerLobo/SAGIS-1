...
@section('content2', 'Editar Estudios Potsgrado')
                        ...
                        <form action="./AdminAddProducto.do" method="GET">
                            <div class="row text-center m-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3 ">
                                        <label for="exampleInputNombrePrograma" class="form-label">Nombre Programa</label>
                                        <input type="number" class="form-control " name="nombrePrograma" id="exampleInputNombrePrograma"
                                            required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <input type="number" class="form-control " name="anioGraduado" id="exampleInputAnio"
                                            required>
                                    </div>
