...
@section('title', 'Editar Estudios de Graduado')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                            ...
                                            <div class="icons-acciones">
                                                ...
                                                <div class="mr-3">
                                                    ...
                                                    <a style="text-decoration: none; color: #000000;"
                                                        href="{{ route('dev.students.academics.edit') }}">
                            ...
                            <div class="modal-footer mt-2 " id="foterM">
                                ...
                                <a href="{{ route('dev.students.academics.create') }}"> <button type="button"
                                        class="btn btn-danger btn-lg  btn-sm mt-5" style="float: right;"> Añadir estudio
                                        potsgrado </button></a>
