                        ...
                        <div class="card-body">
                            ...
                            <form action="./AdminAddProducto.do" method="GET">
                                <div class="row text-center m-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3 ">
                                            ...
                                            <input type="number" class="form-control " name="fijo" id="exampleInputFijo"
                                                required>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="dptoEstado"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <label for="exampleInputdptoEstado"
                                                class="form-label">Departamento/Estado</label>
                                            <select class="form-select" name="dptoEstado"
                                                aria-label="Default select example" required>
                                                <option value="">Selecciona un tipo:</option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3 ">
                                            <label for="exampleInputDireccionR" class="form-label">Direccion
                                                Residencia</label>
                                ...
                                <div class="row text-center m-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3 ">
                                            ...
                                            <input type="number" class="form-control " name="AGP"
                                                id="exampleInputAGP">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3 ">
                                            <label for="exampleInputDireccionR" class="form-label">¿Tiene estudios
                                                potsgrados?</label>
                                            <select class="form-select" name="ciudad"
                                                aria-label="Default select example" required>
                                                <option value="">Selecciona un tipo:</option>
                                ...
                                <div class="row text-center m-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3 ">
                                            ...
                                            <input type="text" class="form-control " name="twlE"
                                                id="exampleInputTelE">
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer mt-2 " id="foterM">
                                    ...
                                    <a href="{{ route('dev.students.academics.index') }}"><button type="button"
                                            class="btn btn-info btn-lg">Guardar prueba</button> </a>
