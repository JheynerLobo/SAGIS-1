                ...
                <div class="col-md-8 offset-md-2">
                    <form action="simple-results.html">
                        <div class="input-group">
                            <input type="search" class="form-control form-control-lg" placeholder="Busca en Eventos">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="row mt-5">
                            ...
                            <div class="col-sm-8">
                                <input id="inicial" name="inicial" onclick="desabilitar()" type="date"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="row mt-5 mr-3">
                            ...
                            <div class="col-sm-8">
                                <input onclick="limitarFecha()" name="final" id="final" type="date"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <!--fecha boton -->
                    <div class="col-md-2">
                        <button type="submit" class="btn btn-danger btn-lg mt-5  btn-circle ">
            ...
            <div class="row  g-5">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card " style="width: 21rem; height: 580px;">
                        <img src="{{ asset('img/ufps2.png') }}" class="cd card-img-top" height="200px" alt="...">
                        <div class="card-body">
                            <p class="fecha">Mayo 05 2022</p>
                            <h5 class="card-title"> <a href="" class="vinculoTitulo">Conferencia de la "Innovación
                                    para la
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card" style="width: 21rem; height: 580px;">
                        <img src="{{ asset('img/ufps1.png') }}" class="cd card-img-top" height="200px" alt="...">
                        <div class="card-body">
                            <p class="fecha">Junio 05 2022</p>
                            <h5 class="card-title"> <a href="" class="vinculoTitulo">Taller Seguridad Cloud - Mayo
                                    6</a>
                            </h5>
                            <p class="card-text">En el marco del SEXTO ENCUENTRO INTERNACIONAL EN CIENCIAS APLICADAS E
                                INGENIERÍA (UNIVERSIDAD-INDUSTRIA) EISI 2022”, se invita a participar en las diferentes
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card" style="width: 21rem; height: 580px;">
                        <img src="{{ asset('img/ufps3.png') }}" class="cd card-img-top" height="200px" alt="...">
                        <div class="card-body">
                            <p class="fecha">Mayo 09 2022</p>
                            <h5 class="card-title"> <a href="" class="vinculoTitulo">Profesores Ponentes Semana
                                    CyT</a>
                            </h5>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card" style="width: 21rem; height: 580px;">
                        <img src="{{ asset('img/G1.jpg') }}" class="cd card-img-top" height="200px" alt="...">
                        <div class="card-body">
                            <p class="fecha">Mayo 05 2022</p>
