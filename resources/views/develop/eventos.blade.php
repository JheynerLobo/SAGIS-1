        ...
        <div class="row  g-5">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card " style="width: 21rem; height: 580px;">
                    <img src="./img/ufps2.png" class="cd card-img-top" height="200px" alt="...">
                    <div class="card-body">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card" style="width: 21rem; height: 580px;">
                    <img src="./img/ufps1.png" class="cd card-img-top" height="200px" alt="...">
                    <div class="card-body">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card" style="width: 21rem; height: 580px;">
                    <img src="./img/ufps3.png" class="cd card-img-top" height="200px" alt="...">
                    <div class="card-body">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card" style="width: 21rem; height: 580px;">
                    <img src="./img/G1.jpg" class="cd card-img-top" height="200px" alt="...">
                    <div class="card-body">
                        <p class="fecha">Mayo 05 2022</p>
